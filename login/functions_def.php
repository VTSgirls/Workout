...
function registerUser($username, $password, $firstname, $lastname, $email, $code, $phone,$biography, $type, $fileName)
{
    ...
    $sql = "INSERT INTO users (username,password,firstname,lastname,email,code,registration_expires,active,phone,user_type,biography)
             VALUES ('$username','$passwordHashed','$firstname','$lastname','$email','$code',DATE_ADD(now(),INTERVAL 1 DAY),0,'$phone','$type','$biography')";
    ...
    if($type == 3) {
        ...
        $sql =  "INSERT INTO `trainers`(`id`, `firstname`, `lastname`, `rating_sum`, `rating_count`,`avatar`) VALUES ('$id','$firstname','$lastname','0','0','$fileName')";
